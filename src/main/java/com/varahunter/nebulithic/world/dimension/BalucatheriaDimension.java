...
import com.varahunter.nebulithic.item.BalucatheriaItem;
...
public class BalucatheriaDimension extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:balucatheria")
	public static final ModDimension dimension = null;
	@ObjectHolder("nebulithic_ascension_rewritten:balucatheria_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public BalucatheriaDimension(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 67);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("balucatheria"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("nebulithic_ascension_rewritten:balucatheria")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("nebulithic_ascension_rewritten:balucatheria"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("nebulithic_ascension_rewritten:balucatheria"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("nebulithic_ascension_rewritten:purple_mebris_forest")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("nebulithic_ascension_rewritten:acrid_wastes")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("nebulithic_ascension_rewritten:blue_mebris_forest")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new BalucatheriaItem().setRegistryName("balucatheria"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("balucatheria_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = BalucatheriaDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("balucatheria_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "balucatheria_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = BalucatheriaDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				public BlockState getDefaultBlock() {
					return UmbrisStoneBlock.block.getDefaultState();
				}
			...
			if (!biomesPatched) {
				for (Biome biome : this.biomes) {
					biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
						{
							carvableBlocks = ImmutableSet.of(UmbrisStoneBlock.block.getDefaultState().getBlock(),
