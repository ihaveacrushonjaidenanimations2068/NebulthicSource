...
public class PolioTree3Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree3Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 152);
	}
