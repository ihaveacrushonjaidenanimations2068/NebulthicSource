...
public class PolioTree10Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree10Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 159);
	}
