...
public class HemoTree11Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree11Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 23);
	}
