...
public class PolioTree5Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree5Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 154);
	}
