...
public class PolioTree6Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree6Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 155);
	}
