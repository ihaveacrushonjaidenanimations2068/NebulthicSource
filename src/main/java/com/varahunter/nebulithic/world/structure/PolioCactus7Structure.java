...
public class PolioCactus7Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioCactus7Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 170);
	}
