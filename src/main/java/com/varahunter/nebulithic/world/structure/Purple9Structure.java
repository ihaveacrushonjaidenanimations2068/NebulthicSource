...
public class Purple9Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Purple9Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 65);
	}
