...
public class PolioTree7Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree7Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 156);
	}
