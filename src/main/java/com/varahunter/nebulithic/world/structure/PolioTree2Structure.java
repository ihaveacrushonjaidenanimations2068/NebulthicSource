...
public class PolioTree2Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree2Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 151);
	}
