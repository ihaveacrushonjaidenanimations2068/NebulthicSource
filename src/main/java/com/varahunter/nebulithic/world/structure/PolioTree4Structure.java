...
public class PolioTree4Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree4Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 153);
	}
