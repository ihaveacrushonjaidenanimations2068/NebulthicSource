...
public class HemoTree4Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree4Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 13);
	}
