...
public class HemoTree10Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree10Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 19);
	}
