...
public class HemoTree3Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree3Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 12);
	}
