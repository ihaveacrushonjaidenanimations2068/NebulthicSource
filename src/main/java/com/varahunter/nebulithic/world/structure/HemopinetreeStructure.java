...
public class HemopinetreeStructure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemopinetreeStructure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 9);
	}
