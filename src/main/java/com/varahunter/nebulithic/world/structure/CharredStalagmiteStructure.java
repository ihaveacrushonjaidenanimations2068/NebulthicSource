...
public class CharredStalagmiteStructure extends NebulithicAscensionRewrittenModElements.ModElement {
	public CharredStalagmiteStructure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 55);
	}
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						if (blockAt.getBlock() == PlumesandBlock.block.getDefaultState().getBlock())
							blockCriteria = true;
						if (!blockCriteria)
							continue;
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("nebulithic_ascension_rewritten", "charred_stalagmite"));
						if (template == null)
							return false;
