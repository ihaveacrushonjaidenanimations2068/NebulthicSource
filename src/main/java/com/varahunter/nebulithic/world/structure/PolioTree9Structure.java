...
public class PolioTree9Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree9Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 158);
	}
