...
public class SeismiteBoulderFeatureStructure extends NebulithicAscensionRewrittenModElements.ModElement {
	public SeismiteBoulderFeatureStructure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 301);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("nebulithic_ascension_rewritten", "seismite_boulder"));
						if (template == null)
							return false;
