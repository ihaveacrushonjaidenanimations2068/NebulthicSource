...
public class PolioTree8Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioTree8Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 157);
	}
