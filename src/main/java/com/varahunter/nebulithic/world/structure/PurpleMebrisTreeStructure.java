...
public class PurpleMebrisTreeStructure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PurpleMebrisTreeStructure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 57);
	}
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						if (blockAt.getBlock() == PurpleMebrisGrassBlock.block.getDefaultState().getBlock())
							blockCriteria = true;
						if (!blockCriteria)
							continue;
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("nebulithic_ascension_rewritten", "purple_mebris_tree"));
						if (template == null)
							return false;
