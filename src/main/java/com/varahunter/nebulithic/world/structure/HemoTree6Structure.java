...
public class HemoTree6Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree6Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 15);
	}
