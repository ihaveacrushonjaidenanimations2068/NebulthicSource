...
public class HemoTree9Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree9Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 18);
	}
