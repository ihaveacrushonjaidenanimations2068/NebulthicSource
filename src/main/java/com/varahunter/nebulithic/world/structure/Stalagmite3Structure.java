...
public class Stalagmite3Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Stalagmite3Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 69);
	}
