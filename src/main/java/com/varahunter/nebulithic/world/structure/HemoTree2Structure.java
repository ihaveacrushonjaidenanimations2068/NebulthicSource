...
public class HemoTree2Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree2Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 11);
	}
