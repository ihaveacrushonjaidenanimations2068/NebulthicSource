...
public class PolioniaTreeStructure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioniaTreeStructure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 149);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("nebulithic_ascension_rewritten:polionia_flatlands")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
