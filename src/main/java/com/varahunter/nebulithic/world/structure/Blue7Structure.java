...
public class Blue7Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Blue7Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 84);
	}
