...
public class HemoTree5Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree5Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 14);
	}
