...
public class HemoTree7Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree7Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 16);
	}
