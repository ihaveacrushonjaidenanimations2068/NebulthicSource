...
public class PolioCactus2Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public PolioCactus2Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 165);
	}
