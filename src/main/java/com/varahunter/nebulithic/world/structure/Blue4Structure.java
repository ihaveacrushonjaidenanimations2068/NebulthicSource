...
public class Blue4Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Blue4Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 81);
	}
