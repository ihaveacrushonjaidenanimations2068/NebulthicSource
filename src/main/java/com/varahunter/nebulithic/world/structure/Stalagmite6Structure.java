...
public class Stalagmite6Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Stalagmite6Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 72);
	}
