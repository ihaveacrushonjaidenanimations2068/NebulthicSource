...
public class Stalagmite4Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Stalagmite4Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 70);
	}
