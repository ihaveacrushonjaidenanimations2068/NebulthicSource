...
public class Stalagmite9Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Stalagmite9Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 75);
	}
