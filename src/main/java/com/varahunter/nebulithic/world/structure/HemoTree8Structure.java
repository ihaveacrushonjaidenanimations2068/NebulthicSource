...
public class HemoTree8Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public HemoTree8Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 17);
	}
