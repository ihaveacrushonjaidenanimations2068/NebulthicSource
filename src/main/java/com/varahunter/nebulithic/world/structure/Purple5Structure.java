...
public class Purple5Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Purple5Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 61);
	}
