...
public class Blue10Structure extends NebulithicAscensionRewrittenModElements.ModElement {
	public Blue10Structure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 87);
	}
