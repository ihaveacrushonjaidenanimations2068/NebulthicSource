...
public class SnowyHillyBarrensBiome extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:snowy_hilly_barrens")
	public static final CustomBiome biome = null;
	public SnowyHillyBarrensBiome(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 129);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			...
			setRegistryName("snowy_hilly_barrens");
