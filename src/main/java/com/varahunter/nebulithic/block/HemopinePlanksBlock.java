...
public class HemopinePlanksBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:hemopine_planks")
	public static final Block block = null;
	public HemopinePlanksBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hemopine_planks");
		}
