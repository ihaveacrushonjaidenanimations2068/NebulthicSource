...
public class Sclerotis261RegolithBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerotis_261_regolith")
	public static final Block block = null;
	public Sclerotis261RegolithBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sclerotis_261_regolith");
		}
