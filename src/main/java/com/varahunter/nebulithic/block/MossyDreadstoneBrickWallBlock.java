...
public class MossyDreadstoneBrickWallBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:mossy_dreadstone_brick_wall")
	public static final Block block = null;
	public MossyDreadstoneBrickWallBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 223);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_dreadstone_brick_wall");
		}
