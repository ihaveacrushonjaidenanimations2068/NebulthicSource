...
public class DreadfulWartBlockBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:dreadful_wart_block")
	public static final Block block = null;
	public DreadfulWartBlockBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 204);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dreadful_wart_block");
		}
