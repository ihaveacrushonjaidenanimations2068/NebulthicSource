...
public class WovenVeinwoodSticksBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:woven_veinwood_sticks")
	public static final Block block = null;
	public WovenVeinwoodSticksBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("woven_veinwood_sticks");
		}
