...
public class SclerocalyptusStairsBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerocalyptus_stairs")
	public static final Block block = null;
	public SclerocalyptusStairsBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 237);
	}
