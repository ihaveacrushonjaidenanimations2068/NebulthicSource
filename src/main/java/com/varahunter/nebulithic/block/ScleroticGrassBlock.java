...
public class ScleroticGrassBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerotic_grass")
	public static final Block block = null;
	public ScleroticGrassBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sclerotic_grass");
		}
