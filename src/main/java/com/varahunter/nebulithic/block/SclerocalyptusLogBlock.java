...
public class SclerocalyptusLogBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerocalyptus_log")
	public static final Block block = null;
	public SclerocalyptusLogBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sclerocalyptus_log");
		}
