...
public class VeinwoodLogBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:veinwood_log")
	public static final Block block = null;
	public VeinwoodLogBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 22);
	}
