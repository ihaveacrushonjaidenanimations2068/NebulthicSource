...
public class BlueMebrisVineBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:blue_mebris_vine")
	public static final Block block = null;
	public BlueMebrisVineBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_mebris_vine");
		}
