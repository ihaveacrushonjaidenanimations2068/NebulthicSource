...
public class DreadfulGrassBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:dreadful_grass")
	public static final Block block = null;
	public DreadfulGrassBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dreadful_grass");
		}
