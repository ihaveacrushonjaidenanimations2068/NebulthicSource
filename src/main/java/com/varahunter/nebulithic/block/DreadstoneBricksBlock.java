...
public class DreadstoneBricksBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:dreadstone_bricks")
	public static final Block block = null;
	public DreadstoneBricksBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 209);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dreadstone_bricks");
		}
