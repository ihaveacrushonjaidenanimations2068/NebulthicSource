...
public class DreadstoneBrickWallBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:dreadstone_brick_wall")
	public static final Block block = null;
	public DreadstoneBrickWallBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 222);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("dreadstone_brick_wall");
		}
