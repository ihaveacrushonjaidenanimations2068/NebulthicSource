...
public class PolioniaGrassBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:polionia_grass")
	public static final Block block = null;
	public PolioniaGrassBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polionia_grass");
		}
