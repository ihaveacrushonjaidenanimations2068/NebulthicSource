...
public class DreadshroomStemBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:dreadshroom_stem")
	public static final Block block = null;
	public DreadshroomStemBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dreadshroom_stem");
		}
