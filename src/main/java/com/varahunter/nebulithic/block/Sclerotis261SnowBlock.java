...
public class Sclerotis261SnowBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerotis_261_snow")
	public static final Block block = null;
	public Sclerotis261SnowBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sclerotis_261_snow");
		}
