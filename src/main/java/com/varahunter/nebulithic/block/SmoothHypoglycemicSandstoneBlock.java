...
public class SmoothHypoglycemicSandstoneBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:smooth_hypoglycemic_sandstone")
	public static final Block block = null;
	public SmoothHypoglycemicSandstoneBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_hypoglycemic_sandstone");
		}
