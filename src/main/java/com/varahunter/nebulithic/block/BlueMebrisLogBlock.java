...
public class BlueMebrisLogBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:blue_mebris_log")
	public static final Block block = null;
	public BlueMebrisLogBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blue_mebris_log");
		}
