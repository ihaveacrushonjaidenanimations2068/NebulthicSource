...
public class PurpleMebrisGrassBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:purple_mebris_grass")
	public static final Block block = null;
	public PurpleMebrisGrassBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_mebris_grass");
		}
