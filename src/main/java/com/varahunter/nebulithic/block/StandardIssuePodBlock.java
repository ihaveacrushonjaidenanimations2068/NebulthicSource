...
public class StandardIssuePodBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:standard_issue_pod")
	public static final Block block = null;
	public StandardIssuePodBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 261);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("standard_issue_pod");
		}
