...
public class NanosiaBlockBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:nanosia_block")
	public static final Block block = null;
	public NanosiaBlockBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 272);
	}
