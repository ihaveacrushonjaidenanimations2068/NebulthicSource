...
public class BlueMebrisLeavesBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:blue_mebris_leaves")
	public static final Block block = null;
	public BlueMebrisLeavesBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_mebris_leaves");
		}
