...
public class PolioniaLogBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:polionia_log")
	public static final Block block = null;
	public PolioniaLogBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 144);
	}
