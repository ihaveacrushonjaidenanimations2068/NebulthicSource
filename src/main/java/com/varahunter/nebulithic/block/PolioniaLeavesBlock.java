...
public class PolioniaLeavesBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:polionia_leaves")
	public static final Block block = null;
	public PolioniaLeavesBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polionia_leaves");
		}
