...
public class ConstructCoreBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:construct_core")
	public static final Block block = null;
	public ConstructCoreBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 279);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("construct_core");
		}
