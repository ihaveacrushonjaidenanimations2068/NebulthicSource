...
public class UmbrisStoneBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:umbris_stone")
	public static final Block block = null;
	public UmbrisStoneBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 67);
	}
