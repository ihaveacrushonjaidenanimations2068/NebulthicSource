...
public class CognitacidBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:cognitacid")
	public static final Block block = null;
	public CognitacidBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 295);
	}
