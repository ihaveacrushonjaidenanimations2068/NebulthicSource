...
public class EyeBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:eye")
	public static final Block block = null;
	public EyeBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 24);
	}
