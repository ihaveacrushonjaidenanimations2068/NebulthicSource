...
public class DreadshroomSporesBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:dreadshroom_spores")
	public static final Block block = null;
	public DreadshroomSporesBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 205);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dreadshroom_spores");
		}
