...
public class MossyDreadstoneBricksBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:mossy_dreadstone_bricks")
	public static final Block block = null;
	public MossyDreadstoneBricksBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 221);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_dreadstone_bricks");
		}
