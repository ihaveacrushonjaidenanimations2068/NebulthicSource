...
public class GallstoneBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:gallstone")
	public static final Block block = null;
	public GallstoneBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 94);
	}
