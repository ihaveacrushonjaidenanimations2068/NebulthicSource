...
public class HemopineLeavesBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:hemopine_leaves")
	public static final Block block = null;
	public HemopineLeavesBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hemopine_leaves");
		}
