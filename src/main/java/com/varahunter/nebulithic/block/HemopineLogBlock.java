...
public class HemopineLogBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:hemopine_log")
	public static final Block block = null;
	public HemopineLogBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 1);
	}
