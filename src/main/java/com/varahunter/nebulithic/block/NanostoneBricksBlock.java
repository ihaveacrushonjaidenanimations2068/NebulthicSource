...
public class NanostoneBricksBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:nanostone_bricks")
	public static final Block block = null;
	public NanostoneBricksBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nanostone_bricks");
		}
