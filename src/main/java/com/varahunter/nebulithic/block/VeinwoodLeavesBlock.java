...
public class VeinwoodLeavesBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:veinwood_leaves")
	public static final Block block = null;
	public VeinwoodLeavesBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("veinwood_leaves");
		}
