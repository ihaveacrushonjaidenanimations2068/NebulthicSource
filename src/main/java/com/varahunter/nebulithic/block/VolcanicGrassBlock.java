...
public class VolcanicGrassBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:volcanic_grass")
	public static final Block block = null;
	public VolcanicGrassBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("volcanic_grass");
		}
