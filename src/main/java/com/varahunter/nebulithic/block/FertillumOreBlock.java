...
public class FertillumOreBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:fertillum_ore")
	public static final Block block = null;
	public FertillumOreBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 202);
	}
