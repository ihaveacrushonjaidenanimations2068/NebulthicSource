...
public class SclerocalyptusPlanksBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerocalyptus_planks")
	public static final Block block = null;
	public SclerocalyptusPlanksBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sclerocalyptus_planks");
		}
