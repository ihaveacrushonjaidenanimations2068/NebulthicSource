...
public class DysenteriumOreBlockBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:dysenterium_ore_block")
	public static final Block block = null;
	public DysenteriumOreBlockBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 114);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dysenterium_ore_block");
		}
