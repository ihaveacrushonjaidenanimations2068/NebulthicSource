...
public class Sclerotis261StoneBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerotis_261_stone")
	public static final Block block = null;
	public Sclerotis261StoneBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sclerotis_261_stone");
		}
