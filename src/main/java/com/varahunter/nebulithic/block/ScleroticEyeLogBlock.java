...
public class ScleroticEyeLogBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerotic_eye_log")
	public static final Block block = null;
	public ScleroticEyeLogBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sclerotic_eye_log");
		}
