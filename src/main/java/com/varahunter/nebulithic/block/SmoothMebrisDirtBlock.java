...
public class SmoothMebrisDirtBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:smooth_mebris_dirt")
	public static final Block block = null;
	public SmoothMebrisDirtBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_mebris_dirt");
		}
