...
public class ScleroticDirtBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerotic_dirt")
	public static final Block block = null;
	public ScleroticDirtBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sclerotic_dirt");
		}
