...
public class PurpleMebrisLogBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:purple_mebris_log")
	public static final Block block = null;
	public PurpleMebrisLogBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("purple_mebris_log");
		}
