...
public class HypoglycemicSandBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:hypoglycemic_sand")
	public static final Block block = null;
	public HypoglycemicSandBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("hypoglycemic_sand");
		}
