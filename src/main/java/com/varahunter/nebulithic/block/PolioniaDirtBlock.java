...
public class PolioniaDirtBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:polionia_dirt")
	public static final Block block = null;
	public PolioniaDirtBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 143);
	}
