...
public class DreadstoneBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:dreadstone")
	public static final Block block = null;
	public DreadstoneBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 201);
	}
