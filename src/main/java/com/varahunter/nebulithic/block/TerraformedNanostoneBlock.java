...
public class TerraformedNanostoneBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:terraformed_nanostone")
	public static final Block block = null;
	public TerraformedNanostoneBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("terraformed_nanostone");
		}
