...
public class SclerocalyptusLeavesBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerocalyptus_leaves")
	public static final Block block = null;
	public SclerocalyptusLeavesBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sclerocalyptus_leaves");
		}
