...
public class HypoglycemicSandstoneBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:hypoglycemic_sandstone")
	public static final Block block = null;
	public HypoglycemicSandstoneBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hypoglycemic_sandstone");
		}
