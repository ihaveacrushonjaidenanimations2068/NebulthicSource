...
public class PurpleMebrisLeavesBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:purple_mebris_leaves")
	public static final Block block = null;
	public PurpleMebrisLeavesBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_mebris_leaves");
		}
