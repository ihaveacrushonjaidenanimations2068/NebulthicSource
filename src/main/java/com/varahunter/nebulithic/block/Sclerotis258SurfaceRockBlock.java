...
public class Sclerotis258SurfaceRockBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:sclerotis_258_surface_rock")
	public static final Block block = null;
	public Sclerotis258SurfaceRockBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sclerotis_258_surface_rock");
		}
