...
public class SeismiteSiltBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:seismite_silt")
	public static final Block block = null;
	public SeismiteSiltBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 303);
	}
