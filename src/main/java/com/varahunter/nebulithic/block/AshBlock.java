...
public class AshBlock extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:ash")
	public static final Block block = null;
	public AshBlock(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 5);
	}
