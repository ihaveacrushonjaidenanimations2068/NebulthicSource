...
public class TankRidableEntity extends NebulithicAscensionRewrittenModElements.ModElement {
	public static EntityType entity = null;
	public TankRidableEntity(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 250);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 18f)).build("tank_ridable")
						.setRegistryName("tank_ridable");
