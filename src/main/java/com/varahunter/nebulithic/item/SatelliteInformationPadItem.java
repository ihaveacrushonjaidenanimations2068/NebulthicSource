...
import com.varahunter.nebulithic.gui.SatelliteInfoGui;
import com.varahunter.nebulithic.NebulithicAscensionRewrittenModElements;

@NebulithicAscensionRewrittenModElements.ModElement.Tag
public class SatelliteInformationPadItem extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:satellite_information_pad")
	public static final Item block = null;
	public SatelliteInformationPadItem(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 266);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof SatelliteInfoGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(NAUtilsItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("satellite_information_pad");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Serves as your communication with the Satellite"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Satellite Information Pad");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new SatelliteInfoGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
