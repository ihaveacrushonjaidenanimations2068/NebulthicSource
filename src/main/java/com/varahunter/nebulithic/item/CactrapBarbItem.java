...
public class CactrapBarbItem extends NebulithicAscensionRewrittenModElements.ModElement {
	@ObjectHolder("nebulithic_ascension_rewritten:cactrap_barb")
	public static final Item block = null;
	@ObjectHolder("nebulithic_ascension_rewritten:entitybulletcactrap_barb")
	public static final EntityType arrow = null;
	public CactrapBarbItem(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 175);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletcactrap_barb").setRegistryName("entitybulletcactrap_barb"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(CactrapBarbItem.block, (int) (1));
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("nebulithic_ascension_rewritten:textures/barb.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new ModelBArb();
