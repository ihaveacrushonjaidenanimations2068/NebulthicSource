...
public class AshlingEggBlockDestroyedByPlayerProcedure extends NebulithicAscensionRewrittenModElements.ModElement {
	public AshlingEggBlockDestroyedByPlayerProcedure(NebulithicAscensionRewrittenModElements instance) {
		super(instance, 92);
	}
